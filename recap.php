...
<body class="bg-secondary">
        <nav class="d-flex justify-content-center gap-5 mt-5">
            ...
            <button type="button" onclick="location.href='recap.php'" class="btn btn-warning position-relative">
                ...
                <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-dark">+99 <span class="visually-hidden">unread messages</span></span>
            </button>
            ...
            echo "<div class='container-sm bg-warning  rounded-4 shadow mt-5'><table class='table'>",
                ...
                foreach($_SESSION['products'] as $index => $products){
                    echo "<tr>",
                            ...
                            "<td class='fs-2 text-secondary'>".$products['name']."</td>",
                            //fonction number_format() permet de modifier l'affichage d'une valeur numérique
                            "<td class='fs-2 text-secondary'>".number_format($products['price'],2,",","&nsbp;")." €</td>",
                            "<td class='fs-2 text-secondary'>".$products['qtt']."</td>",
                            "<td class='fs-2 text-secondary'>".number_format($products['total'],2,",","&nsbp;")." €</td>",
                          "</tr>";
