...
<body>
    ...
    <header>
        <nav class="d-flex justify-content-center gap-5 mt-5">
            <button type="button" onclick="location.href='index.php'"class="btn btn-primary position-relative">
                Home 
            </button>
            ...
            <button type="button" onclick="location.href='recap.php'" class="btn btn-primary position-relative">
                ...
                <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-dark"><?php echo count($_SESSION['products'])?></span>
            </button>
